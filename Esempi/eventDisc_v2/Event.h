...
class Event {
 ...
 public:
  ...
  Event( int n,
   ...
   pA  ( a  ),
   pB  ( b  ),
   pType ( t ? DiscriminatorClassification::signal :
               DiscriminatorClassification::background ) {
  }
  ...
  // return event type
  DiscriminatorClassification::Type evType() const { return pType; }
 ...
 private:
  ...
  // event type
  DiscriminatorClassification::Type pType;
